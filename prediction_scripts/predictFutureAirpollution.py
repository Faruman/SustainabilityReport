...
plt.savefig(os.path.join(base_path, "plots", "airPollution19902030_V2.png"))
plt.show()
...
for i, pollutant in enumerate(pollutants):
    ...
    plt.savefig(os.path.join(base_path, "plots", "Development_{}_{:.0f}_{:.0f}_woIntervention_V2.png".format(pollutant, x.min(), x.max())))
    plt.show()
